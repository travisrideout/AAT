...
public class FallingPlate extends IOIOActivity implements OnClickListener{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		debug = getPrefs.getBoolean("cbDebug", false);		
		...
		switch (game){
		case 1:
			setTitle(R.string.title_activity_falling_plate);			
			break;
		case 2:			
			setTitle(R.string.title_activity_random_plate);
			break;
		case 3:
			setTitle(R.string.title_activity_countdown);
			break;
		case 4:
			setTitle(R.string.title_activity_stay_down);
			difficulty = (settings.getInt("Difficulty", 2));
			break;
		case 5:
			setTitle(R.string.title_activity_whack_amole);
			tvTimerValue.setTextSize(60);
			tvTimerValue.setText("00:0 HITS:00");
			tvSessionsTitleBar.setText("ROUND"+"    "+"HITS"+"   "+"MISSES");
			break;
		case 6:
			setTitle(R.string.title_activity_free_style);
			break;
		}
...
public void startRound() {
	...
	private Runnable hitHandler = new Runnable(){
		public void run(){
			if(game==6&&timerrunning==true||game==6&&go==true){
				updateHitCounter();			
				customHandler.postDelayed(flash, flashDuration);
			}else{
				if (timerrunning==true){
					switch (plateNumber){
					case 1: Target1LED.setChecked(false);
							Target1LED.setEnabled(false);
						break;
					case 2: Target2LED.setChecked(false);
							Target2LED.setEnabled(false);
						break;
					case 3: Target3LED.setChecked(false);
							Target3LED.setEnabled(false);
						break;
					case 4: Target4LED.setChecked(false);
	...
	public void roundEndCheck() {
		...
		case 3: //Countdown
			...
			break;			
		case 4: //Staydown
			if(Target1LED.isChecked()==false&&Target2LED.isChecked()==false
				&&Target3LED.isChecked()==false&&Target4LED.isChecked()==false){
				if(resets==0){
					reset();
					if(autoStartDelay != 0){
						customHandler.postDelayed(autoStartThread, (autoStartDelay * 1000));
	...
	public void getNextPlate() {	
		...
		if (selectedPlate==plateNumber){
			...
			case 1: Target1LED.setChecked(true);
					Target1LED.setEnabled(true);
			break;
			case 2: Target2LED.setChecked(true);
					Target2LED.setEnabled(true);
			break;
			case 3: Target3LED.setChecked(true);
					Target3LED.setEnabled(true);
			break;
			case 4: Target4LED.setChecked(true);
